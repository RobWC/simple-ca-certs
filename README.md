...
```
[dev:simple-ca-certs]# ./sign_cert_csr.sh  <pre><b>testcert3</b></pre>
...
Common Name (eg, YOUR name) []: <pre><b>food.goo.com</b></pre>
Email Address []:
...
Sign the certificate? [y/n]: <pre><b>y<pre><b>


1 out of 1 certificate requests certified, commit? [y/n] <pre><b>y</b></pre>
